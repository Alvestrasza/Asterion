...
def extras(kind, component):
    ...
    if component == 'armor':
        result.update(asterion_equipment_slot='outfit', asterion_equipment_id=kind + '-outfit-v1')
    return result
...
def inspect(document, kind, bones):
    ...
    checks = {
        ...
        'under_two_million_triangles': 0 < triangles < 2000000,
...
def export(path, kind, groups, rig):
    ...
    report['checks']['under_25_mb'] = report['bytes'] < 25000000
