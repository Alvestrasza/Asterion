"""Independent Caelo v002 GLB motion diagnostics and six-view contact sheet.

Run in Blender, for example:
  blender --background --factory-startup --python inspect_motion.py --
    --glb /absolute/pony-sculpt-v002.glb --output /absolute/new/private/review
...
def contact_sheet(output, renders):
    ...
    path = output / 'pony-v002-motion-contact-sheet.png'
...
def main():
    ...
    for item in sample_reports:
        ...
        name = f"pony-{item['clip']}-f{item['frame']:03d}"
