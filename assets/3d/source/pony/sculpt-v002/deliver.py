"""Hash-checked Caelo v002 handoff into new, versioned local asset paths.
...
def main():
    ...
    glb=work/'pony-sculpt-v002.glb';blend=work/'pony-sculpt-v002.blend'
    original=REPO/'public'/'assets'/'companions'/'pony.png'
    ...
    review=REPO/'assets'/'3d'/'reference'/'pony'/'sculpt-v002'
    public=REPO/'public'/'assets'/'3d'/'pony'/glb.name
    ...
    manifest={
        'schema':'asterion-local-companion-sculpt-v1','kind':'pony','name':'Caelo','version':'sculpt-v002',
        ...
        'provenance':'Locally modeled from unchanged pony.png. Hidden views inferred; source and historical v001 preserved.',
