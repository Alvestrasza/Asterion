...
const en = {
  ...
  online: "Online", offline: "Offline", level: "Player level", privacy: "Only confirmed friends can see your online status and player level. Finding someone requires their friend code, not a name or email address. Online status may take up to 90 seconds to update.",
...
const de: Messages = {
  ...
  online: "Online", offline: "Offline", level: "Spielerstufe", privacy: "Nur bestätigte Freunde sehen deinen Online-Status und deine Spielerstufe. Zum Finden brauchst du den Freundescode, keinen Namen und keine E-Mail-Adresse. Der Online-Status kann bis zu 90 Sekunden verzögert sein.",
...
const fr: Messages = {
  ...
  online: "En ligne", offline: "Hors ligne", level: "Niveau du joueur", privacy: "Seuls tes amis confirmés voient ton statut et ton niveau de joueur. Pour trouver quelqu’un, utilise son code ami, pas son nom ni son e-mail. Le statut peut avoir 90 secondes de retard.",
...
const es: Messages = {
  ...
  online: "En línea", offline: "Desconectado", level: "Nivel del jugador", privacy: "Solo los amigos confirmados ven tu estado y tu nivel de jugador. Para encontrar a alguien necesitas su código de amigo, no un nombre ni una dirección de correo. El estado puede tardar hasta 90 segundos en actualizarse.",
